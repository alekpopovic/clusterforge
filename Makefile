...
CLI_LDFLAGS := -s -w -X github.com/alekpopovic/clusterforge/cli/cmd.Version=$(CLI_VERSION) -X github.com/alekpopovic/clusterforge/cli/cmd.Commit=$(CLI_COMMIT) -X github.com/alekpopovic/clusterforge/cli/cmd.Date=$(CLI_DATE) -X github.com/alekpopovic/clusterforge/cli/internal/generator.ModuleRef=$(CLI_VERSION)
