variable "namespace" {
  description = "Kubernetes namespace for the metrics-server Helm release."
  type        = string
  default     = "metrics-server"
}

variable "chart_version" {
  description = "Optional metrics-server chart version. Leave empty to use the latest provider-resolved version."
  type        = string
  default     = ""
}
