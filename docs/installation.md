...
Windows amd64. The current stable release is `v0.4.1`. Install
...
```bash
curl -fsSL \
  https://github.com/alekpopovic/clusterforge/releases/download/v0.4.1/install.sh \
  | VERSION=v0.4.1 bash
```
...
curl -fsSL \
  https://github.com/alekpopovic/clusterforge/releases/download/v0.4.1/install.sh \
  | VERSION=v0.4.1 INSTALL_DIR=/usr/local/bin bash
```
...
```bash
curl -fsSL https://github.com/alekpopovic/clusterforge/releases/download/v0.4.1/install.sh \
  | VERSION=v0.4.1 bash
cf version
cf upgrade check
cf upgrade plan
