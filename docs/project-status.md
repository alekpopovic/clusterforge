...
ClusterForge is currently published as `v0.4.2`. This stable version label is
...
|---|---|
| GitHub Release | `v0.4.2`, published as a stable release with checksum-verified installers |
...
| Cloud smoke tests | No current production-cloud apply evidence is claimed for v0.4.2 |
