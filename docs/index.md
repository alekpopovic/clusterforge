...
<div class="grid">
  ...
  <div class="card">
    <h3>Observability</h3>
    <p>Install metrics, logging, and telemetry agents with conservative defaults.</p>
    <p><a href="{{ '/observability/' | relative_url }}">Plan observability</a></p>
  </div>
  <div class="card">
    <h3>Security</h3>
...
- [Observability]({{ '/observability/' | relative_url }})
